...
class UsersTests {
    ...
    fun `create user with invalid email`() {
        ...
        // when: doing a POST
        UsersTestsUtils.createInvalidUser(testClient, initialUser, Problem.invalidEmail)
    }
    ...
    fun `create user with invalid username`() {
        ...
        // when: doing a POST
        UsersTestsUtils.createInvalidUser(testClient, initialUser, Problem.invalidName)
    }
