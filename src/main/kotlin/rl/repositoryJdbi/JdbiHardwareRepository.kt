...
import rl.repository.HardwareRepository
...
data class JdbiHardwareRepository(
    ...
    override fun updateHardwareName(hwId: Int, hwName: HardwareName): Boolean =
        handle.createUpdate(
            """
            UPDATE rl.hardware 
            SET hw_name = :hw_name
    ...
    override fun updateHardwareStatus(hwId: Int, hwStatus: HardwareStatus): Boolean =
        handle.createUpdate(
            """
            UPDATE rl.hardware 
            SET status = :status
    ...
    override fun updateHardwareIpAddress(hwId: Int, ipAddress: String): Boolean =
        handle.createUpdate(
            """
            UPDATE rl.hardware 
    ...
    override fun updateHardwareMacAddress(hwId: Int, macAddress: String): Boolean =
        handle.createUpdate(
            """
            UPDATE rl.hardware 
